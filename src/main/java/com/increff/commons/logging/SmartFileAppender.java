...
public class SmartFileAppender extends FileAppender {
	 ...
	 * before being opened.
	 */
	public SmartFileAppender(Layout layout, String filename, boolean append) throws IOException {
	 ...
	 */
	public SmartFileAppender(Layout layout, String fileName) throws IOException {
